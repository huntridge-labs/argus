...
from argus.scn.defaults import (
    DEFAULT_AI_CONFIG,
...
class TestDefaults:
    ...
    def test_default_ai_config_exists(self):
        ...
        assert isinstance(DEFAULT_AI_CONFIG, dict)
    ...
    def test_merge_config_simple(self):
        ...
        result = merge_config(custom, defaults_cfg)
    ...
    def test_default_ai_config_has_no_enabled_field(self):
        ...
        assert 'enabled' not in DEFAULT_AI_CONFIG
    ...
    def test_merge_config_non_dict_custom(self):
        ...
        assert merge_config('string', defaults_cfg) == defaults_cfg
        assert merge_config(42, defaults_cfg) == defaults_cfg
        assert merge_config(['list'], defaults_cfg) == defaults_cfg
