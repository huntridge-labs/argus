...
from argus.scn.classifier import ChangeClassifier
...
class TestChangeClassifier:
    ...
    def classifier(self, minimal_config):
        ...
        return ChangeClassifier(config=minimal_config)
    ...
    def test_initialization_custom_config(self, minimal_config):
        ...
        classifier = ChangeClassifier(config=minimal_config)
...
class TestProviderConfiguration:
    ...
    def test_openai_api_key_resolved(self):
        ...
        classifier = ChangeClassifier(config=config)
