...
from argus.scn.ai import AIClassifier
...
class TestAIClassifierInit:
    ...
    def test_init_no_api_key(self):
        ...
        classifier = AIClassifier(api_key=None)
    ...
    def test_init_custom_config(self):
        ...
        classifier = AIClassifier(ai_config=config, api_key='test-key')
    ...
    def test_init_openai_api_key_from_env(self):
        ...
        classifier = AIClassifier(ai_config=config)
    ...
    def test_init_unknown_provider_no_crash(self):
        ...
        classifier = AIClassifier(ai_config=config, api_key='key')
        assert classifier.provider is None
