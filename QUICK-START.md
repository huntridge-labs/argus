...
jobs:
  trivy-iac:
    uses: huntridge-labs/argus/.github/workflows/scanner-trivy-iac.yml@0.6.2
    with:
  ...
  checkov:
    uses: huntridge-labs/argus/.github/workflows/scanner-checkov.yml@0.6.2
    with:
      iac_path: 'infrastructure'
...
jobs:
  scan-image:
    uses: huntridge-labs/argus/.github/workflows/scanner-trivy-container.yml@0.6.2
    with:
