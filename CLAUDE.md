...
|----------|---------|---------------|
| **SAST** | scanner-codeql<br>scanner-bandit<br>scanner-gosec<br>scanner-opengrep<br>scanner-m | Multi-language<br>Python<br>Go<br>Pattern-based<br>MUMPS / M (phase 1) |
