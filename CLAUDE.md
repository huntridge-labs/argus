...
|----------|---------|---------------|
| **SAST** | scanner-codeql<br>scanner-bandit<br>scanner-gosec<br>scanner-opengrep<br>scanner-mumps | Multi-language<br>Python<br>Go<br>Pattern-based<br>MUMPS / M (16 rules: M001-M006, M101-M102, M201-M208 — mHawk taint-sink parity + 10 diagnostics) |
