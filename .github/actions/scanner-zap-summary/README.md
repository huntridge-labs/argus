...
- name: Generate ZAP Summary
  uses: huntridge-labs/argus/.github/actions/scanner-zap-summary@0.7.1
  id: summary
...
jobs:
  parse-config:
    ...
    steps:
      ...
      - uses: huntridge-labs/argus/.github/actions/parse-zap-config@0.7.1
        id: parse
        with:
  ...
  zap-scan:
    ...
    steps:
      - uses: actions/checkout@v6
      - uses: huntridge-labs/argus/.github/actions/scanner-zap@0.7.1
        with:
