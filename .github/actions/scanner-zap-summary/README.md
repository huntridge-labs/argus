...
- name: Generate ZAP Summary
  uses: huntridge-labs/argus/.github/actions/scanner-zap-summary@1.12.6
  id: summary
...
jobs:
  parse-config:
    ...
    steps:
      ...
      - uses: huntridge-labs/argus/.github/actions/parse-zap-config@1.12.6
        id: parse
        with:
  ...
  zap-scan:
    ...
    steps:
      - uses: actions/checkout@v6
      - uses: huntridge-labs/argus/.github/actions/scanner-zap@1.12.6
        with:
